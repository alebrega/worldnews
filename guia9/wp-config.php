...
define('DB_NAME', 'guia9');

//tLk8a0^3 guia9
if ($_SERVER['SERVER_ADDR']=="64.207.184.155"){
    define('DB_USER', 'guia9');
    define('DB_PASSWORD', 'tLk8a0^3');
    define('WP_HOME','http://guia9.com');
    define('WP_SITEURL','http://guia9.com');
}else{
    define('DB_USER', 'root');
    define('DB_PASSWORD', '');
}
